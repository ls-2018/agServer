...
import (
	...
	appsv1alpha1 "my.domain/guestbook/apis/apps/v1alpha1"
	...
	v1alpha1 "my.domain/guestbook/pkg/client/listers/apps/v1alpha1"
)
...
type GuestBookInformer interface {
	...
	Lister() v1alpha1.GuestBookLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MyV1alpha1().GuestBooks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MyV1alpha1().GuestBooks(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv1alpha1.GuestBook{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *guestBookInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1alpha1.GuestBook{}, f.defaultInformer)
}

func (f *guestBookInformer) Lister() v1alpha1.GuestBookLister {
	return v1alpha1.NewGuestBookLister(f.Informer().GetIndexer())
}
