...
// MyV1alpha1Client is used to interact with features provided by the my.domain/guestbook group.
type MyV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MyV1alpha1Client) GuestBooks(namespace string) GuestBookInterface {
