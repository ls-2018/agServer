...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GuestBookInstance) DeepCopyInto(out *GuestBookInstance) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GuestBookInstance.
func (in *GuestBookInstance) DeepCopy() *GuestBookInstance {
	if in == nil {
		return nil
	}
	out := new(GuestBookInstance)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GuestBookStatus) DeepCopyInto(out *GuestBookStatus) {
	*out = *in
	if in.Instances != nil {
		...
		*out = make([]GuestBookInstance, len(*in))
		copy(*out, *in)
	}
}
